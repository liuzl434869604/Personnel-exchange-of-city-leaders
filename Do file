...
preserve
keep name_prefecture  code_prefecture  Rotation* mayor  year
duplicates drop name_prefecture mayor year, force
save  Rotation_temp,replace
restore

*
preserve
replace year = year + 1 
rename Rotation_dummy Rotation_dummy_temp
merge m:1  mayor name_prefecture year  using  Rotation_temp.dta, keepusing(Rotation_dummy)
drop  if  _merge==2

rename  Rotation_dummy  Rotation_dummy_1_year_af
drop  _merge
...
rename  Rotation_dummy  Rotation_dummy_1_year_be
drop  _merge

rename  Rotation_dummy_temp Rotation_dummy


**
cap drop    Rotation_term_instant_?
gen  Rotation_term_instant_1 = (Rotation_dummy_1_year_be == 0 & Rotation_dummy == 1 & Rotation_dummy_1_year_af==0 )  
gen  Rotation_term_instant_2 = (Rotation_dummy_1_year_be >= 1 & Rotation_dummy == 0 & Rotation_dummy_1_year_af >=1 )  

cap drop did_m_sample
gen did_m_sample=0
replace  did_m_sample=1  if   (Rotation_dummy_1_year_be==0  &  Rotation_dummy==0 ) |  (Rotation_dummy_1_year_be==0 & Rotation_dummy==1)
replace  did_m_sample=1  if   ( Rotation_dummy==1  & Rotation_dummy_1_year_af==0 ) |  (Rotation_dummy==1  & Rotation_dummy_1_year_af==1 )
replace   did_m_sample = 0 if  Rotation_term_instant_1==1 | Rotation_term_instant_2 == 1


reghdfe   ln_cod_emis Rotation_dummy  $controls  if  cod_emission >0 & year>=2006 & did_m_sample==1  , a( $fe  ) vce(cluster firm)   
est sto  did_new_cod_4

reghdfe   ln_nh3_emis  Rotation_dummy  $controls  if  nh3_emission >0 & year>=2006  & did_m_sample==1 , a( $fe  ) vce(cluster firm) 
est sto  did_new_nh3_4

reghdfe   ln_wastewater_emis  Rotation_dummy   $controls  if  wastewater_emission >0 & year>=2006  & did_m_sample==1 , a( $fe  ) vce(cluster firm)  
